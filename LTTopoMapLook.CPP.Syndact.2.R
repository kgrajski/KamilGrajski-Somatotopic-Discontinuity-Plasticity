...
x11(); par(mfrow=c(3,2));
subTitleText = "\nBaseline Refinement";
iWhich = 1; ShowThreeDigitRFTrack1 ( base$rfTrackData.e[[iWhich]], paste(paste("E-Type","Iter",0,sep=" "),subTitleText, sep=""), TRUE, 0.5, 0, 1 );
iWhich = iTop.base; ShowThreeDigitRFTrack1 ( base$rfTrackData.e[[iWhich]], paste(paste("E-Type","Iter",iBase,sep=" "),subTitleText, sep=""), TRUE, 0.5, 0, 1 );
...
iWhich = iTop.syndact; ShowThreeDigitRFTrack1 ( syndact$rfTrackData.e[[iWhich]], paste(paste("E-Type","Iter",iBase,sep=" "),subTitleText, sep=""), TRUE, 0.5, 0, 1 );
...
iWhich = iTop.syndactRel; ShowThreeDigitRFTrack1 ( syndactRel$rfTrackData.e[[iWhich]], paste(paste("E-Type","Iter",iBase,sep=" "),subTitleText, sep=""), TRUE, 0.5, 0, 1 );
...
iWhich = iTop.base; ShowThreeDigitRFTrack2 ( base$rfTrackData.i[[iWhich]], paste(paste("I-Type","Iter",iBase,sep=" "),subTitleText, sep=""), TRUE, 0.5, 0, 1 );
...
iWhich = iTop.syndact; ShowThreeDigitRFTrack2 ( syndact$rfTrackData.i[[iWhich]], paste(paste("I-Type","Iter",iBase,sep=" "),subTitleText, sep=""), TRUE, 0.5, 0, 1 );
...
iWhich = iTop.syndactRel; ShowThreeDigitRFTrack2 ( syndactRel$rfTrackData.i[[iWhich]], paste(paste("I-Type","Iter",iBase,sep=" "),subTitleText, sep=""), TRUE, 0.5, 0, 1 );
...
iWhich = iTop.base; ShowThreeDigitRFTrack3 ( base$rfTrackData.e[[iWhich]], paste(paste("E-Type","Iter",iBase,sep=" "),subTitleText, sep=""), TRUE, 0.5, 0, 3 );
...
iWhich = iTop.syndact; ShowThreeDigitRFTrack3 ( syndact$rfTrackData.e[[iWhich]], paste(paste("E-Type","Iter",iBase,sep=" "),subTitleText, sep=""), TRUE, 0.5, 0, 3 );
...
iWhich = iTop.base; ShowThreeDigitRFTrack3 ( base$rfTrackData.i[[iWhich]], paste(paste("I-Type","Iter",iBase,sep=" "),subTitleText, sep=""), TRUE, 0.5, 0, 3 );

subTitleText = "\nSyndactyly";
iWhich = 1; ShowThreeDigitRFTrack3 ( syndact$rfTrackData.i[[iWhich]], paste(paste("I-Type","Iter",0,sep=" "),subTitleText, sep=""), TRUE, 0.5, 0 );
iWhich = iTop.syndact; ShowThreeDigitRFTrack3 ( syndact$rfTrackData.i[[iWhich]], paste(paste("I-Type","Iter",iBase,sep=" "),subTitleText, sep=""), TRUE, 0.5, 0, 3 );

subTitleText = "\nSyndactyly Release";
iWhich = 1; ShowThreeDigitRFTrack3 ( syndactRel$rfTrackData.i[[iWhich]], paste(paste("I-Type","Iter",0,sep=" "),subTitleText, sep=""), TRUE, 0.5, 0 );
...
minDiv = min ( c ( div.base.init, div.base.final ) );
maxDiv = max ( c ( div.base.init, div.base.final ) );

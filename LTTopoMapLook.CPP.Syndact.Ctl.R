#
#
#	LTTopoMapLook.CPP.Syndact.Ctl.R
#
#	Use in conjunction with LTTopoMapLook.CPP.Syndact
#
#	This script produces the same scripts as LTTopoMapLook.CPP.Syndact, but the inputs are
...
#syndact.syndactRel = GetStimCountData ( fileRootName, N2 );
...
iWhich = itop.base; titleText = paste ( "Intracolumnar Receptive Field Divergence\nBaseline Refinement\nIter ", (iWhich-1), sep="" );
...
iWhich = itop.syndact; titleText = paste ( "Intracolumnar Receptive Field Divergence\nSyndactyly\nIter ", (iWhich), sep="" );
...
iWhich = itop.syndactRel; titleText = paste ( "Intracolumnar Receptive Field Divergence\nSyndactyly Release\nIter ", (iWhich), sep="" );
...
div.base.final.cellList = c ( 276, 306, 696 );
...
fRoot.last = paste ( "SyndactCtl", iBase, iBase, sep="." );
